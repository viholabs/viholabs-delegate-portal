...
// ✅ OPERATIVA (ús diari)
const OPERATIVA: Group[] = [
  {
    label: "Facturas",
    items: [
      { label: "Importación", href: "/control-room/import" },
      // Preparat per quan tinguis pantalles dedicades:
      // { label: "Review", href: "/control-room/invoices/review" },
      // { label: "Promote", href: "/control-room/invoices/promote" },
    ],
  },
  {
    label: "Pedidos",
